	...
	public function job_listing_fields() {
		...
		$fields = array(
			'_job_location' => array(
				...
				'type'  => 'select',
				'options' => array(
                   'South Yorkshire' => __( 'South Yorkshire' ),
                   'West Yorkshire' => __( 'West Yorkshire' ),
                   'East Yorkshire'   => __( 'East Yorkshire' ),
                   'Derbyshire'     => __( 'Derbyshire' ),
                   'Nottinghamshire'     => __( 'Nottinghamshire' ),
                 )
			),
			'_application' => array(
